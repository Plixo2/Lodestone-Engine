...
public class Rect {
	...
	public void draw(float mouseX, float mouseY) {
		...
		Gui.drawRoundetRect(parentOffset.x + x, parentOffset.y + y, parentOffset.x + x + width, parentOffset.y + y + height,roundness,  ColorLib.getDarker(color));
		Gui.drawRoundetRect(parentOffset.x + x+0.5f, parentOffset.y + y+0.5f, parentOffset.x + x + width-0.5f, parentOffset.y + y + height-0.5f,roundness,  color);
