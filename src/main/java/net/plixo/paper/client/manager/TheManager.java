...
public class TheManager {
    ...
    public static void loadGlobals() {
        parser = new JsonParser();
        globals.clear();
        File load = SaveUtil.getFileFromName("globals", SaveUtil.FileFormat.Meta);
        JsonElement element = SaveUtil.loadFromJson(parser, load);
    ...
    public static void loadResources() {
        parser = new JsonParser();
        File load = SaveUtil.getFileFromName("resources", SaveUtil.FileFormat.Meta);
        JsonElement element = SaveUtil.loadFromJson(parser, load);
    ...
    public static void saveGlobals() {
        File file = SaveUtil.getFileFromName("globals", SaveUtil.FileFormat.Meta);
        JsonObject obj = new JsonObject();
        JsonArray array = new JsonArray();
    ...
    public static void saveResources() {
        File file = SaveUtil.getFileFromName("resources", SaveUtil.FileFormat.Meta);
