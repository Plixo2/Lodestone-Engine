...
public class ClassPaths {
    ...
    public static void generate() {
        ...
        try {
            ...
            while (myCL != null) {
                    for (Iterator<? extends Class<?>> iter = list(myCL); iter.hasNext(); ) {
        ...
        UMath.print("Loaded " + dyn + " classes with extra " + (names.size()-dyn) + " standard classes");
    }

    static Iterator<? extends Class<?>> list(ClassLoader CL)
