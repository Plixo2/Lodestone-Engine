...
public class RScript {
    ...
    /**
     * from https://datacadamia.com/lang/java/dynamic 21.07.2021
     */
    public static Object createClass(String jarPath, String jarCode, Object... objects) throws Exception {
        ...
        for (Diagnostic<?> diagnostic : diagnostics.getDiagnostics()) {
            ...
            if (line >= 0)
                UMath.print("Error on line " + line + " in " + diagnostic.getSource());
        }

        fileManager.close();

        try {
            ClassLoader classLoader = RScript.class.getClassLoader();
